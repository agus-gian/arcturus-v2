...
function AffiliateEditModal({ modal_data }) {
    ...
    const { data, setData, patch, processing, errors } = useForm({
        ...
        name: modal_data.detail_item.name,
        phone_code_number: modal_data.detail_item.phone_code_number,
        phone_number_only: modal_data.detail_item.phone_number_only,
        password: '',
    ...
    function submit(e) {
        e.preventDefault()
        patch(`/dashboard/admin/affiliate/${modal_data.detail_item.id}`,{
            preserveState: true,
            preserveScroll: true
        })
    }
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="mb-3">
                                ...
                                <input id="email" type="text" className={`form-control bg-light`} value={modal_data.detail_item.email} readOnly={true} />
                            </div>
