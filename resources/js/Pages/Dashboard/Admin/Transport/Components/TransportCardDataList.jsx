...
function TransportCardDataList({ page_title, items }) {
    ...
    const handleActive = (item_id, value) => {
        router.visit(`/dashboard/admin/transport/active/${item_id}`,{
            method: 'patch',
            data: {
    ...
    const handleCreate = () => {
        ...
        router.visit(`/dashboard/admin/transport/create`, {
            method: 'get',
            data: getReqQuery,
            preserveState: true,
            preserveScroll: true
    ...
    const ActionBtn = (id, action) => {
        ...
        if (action === 'view') {
            url_modal = `/dashboard/admin/transport/${id}`;
        }

        if (action === 'edit') {
            url_modal = `/dashboard/admin/transport/${id}/edit`;
        }
...
export default TransportCardDataList;
