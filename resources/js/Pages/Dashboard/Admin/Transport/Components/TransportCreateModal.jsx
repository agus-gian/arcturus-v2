...
function TransportCreateModal({ modal_data }) {
    const { getReqQuery } = usePage().props;
    const [isLoading, setIsLoading] = useState(false);
    const [selectedCountryId, setSelectedCountryId] = useState(null);
    const [selectedStateId, setSelectedStateId] = useState(null);
    const [selectedCityId, setSelectedCityId] = useState(null);
    const [optionsStateId, setOptionsStateId] = useState([]);
    const [optionsCityId, setOptionsCityId] = useState([]);
    const closeModal = () => {
        setIsLoading(true);
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        name_user: '',
        phone_code_number_user: '62',
        phone_number_only_user: '',
        email_user: '',
        password_user: '',
        name_transport: '',
        address_transport: '',
        country_id_transport: '',
        state_id_transport: '',
        city_id_transport: '',
        email_transport: '',
        phone_code_number_transport: '62',
        phone_number_only_transport: '',
        price_transport: '',
        active: true,
    })
    ...
    function submit(e) {
        e.preventDefault()
        post(`/dashboard/admin/transport`,{
            preserveState: true,
            preserveScroll: true
        })
    }
                ...
                <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Create User Transport</h5>
                        </div>
                            ...
                            <div className="row">
                                <div className="col-6">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input id="password_user" type="password" className={`form-control ${errors.password_user && 'is-invalid'}`} value={data.password_user} onChange={e => setData('password_user', e.target.value)} />
